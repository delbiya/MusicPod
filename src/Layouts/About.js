...
function About({ uiState, setUiState }) {
    let questionOne = "What even is MusicPod?";
    let answerOne =
        "In simple words, it is a music player without ads or distractions that allows you to listen to MusicPod music (hence the name...) while you’re coding or doing other work. It is just a weekend project and uses music available on MusicPod (details below)";
    let questionTwo = "Who made this?";
    let answerTwo =
        "This project was created by PDF. A Computer Science student, developer, and designer who likes creating awesome things that live on the internet! If you like what you just saw and would like to see more, then scroll below to check his socials!";
        ...
        <div className={`about ${uiState.aboutShown ? "" : "about--hidden"}`}>
            ...
            <div className="about__wrapper">
                ...
                <div className="about-group">
                    <p>Hey There,</p>
                    <AboutHeadline content="Welcome to MusicPod!" />
                </div>
                {/* Need img */}
                <AboutImg />
                {/* Need Questions */}
                ...
                <div className="about-socials">
                    <div className="about-socials-group">
                        ...
                        <p className="about-socials-text">@delbu_a_a</p>
                    </div>
                    <div className="about-socials-group">
